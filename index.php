            ...
            <div class="relative max-w-md mx-auto lg:max-w-full" data-aos="fade-left" data-aos-duration="1000">
                ...
                <div class="relative">
                    ...
                    <div class="absolute bottom-10 -right-5 w-36 h-36 glassmorphism rounded-lg p-4 border border-gray-700/50 animate-float animation-delay-1000 shadow-xl shadow-neon-blue">
                        <div class="flex justify-center items-center h-full text-center">
                            <div>
                                <div class="text-transparent bg-clip-text bg-gradient-to-r from-secondary-500 to-accent-500 text-xl font-bold mb-1">12M</div>
                                <p class="text-white text-sm font-semibold">Indians need blood yearly</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Current Urgent Blood Needs -->
<section class="bg-gradient-dark py-12">
    <div class="container mx-auto px-4">
        <div class="text-center mb-10">
            <h2 class="text-3xl font-bold text-white mb-2">Current Urgent Blood Needs</h2>
            <p class="text-gray-400">These blood types are critically needed right now</p>
        </div>
            ...
            <table class="w-full bg-gray-800 rounded-lg overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-700">
                    <tr class="hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3 text-gray-300">AIIMS Hospital Delhi</td>
                        <td class="px-4 py-3 text-gray-300">3 units</td>
                        <td class="px-4 py-3">
                            <span class="bg-red-900 text-red-100 px-3 py-1 rounded-full text-sm">Critical</span>
                        </td>
                        <td class="px-4 py-3">
                            <a href="donation_centers.php" class="bg-primary-600 hover:bg-primary-700 text-white py-1 px-4 rounded">Donate</a>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-700">
                        <td class="px-4 py-3 font-bold text-primary-500">AB+</td>
                        <td class="px-4 py-3 text-gray-300">Fortis Memorial Hospital</td>
                        <td class="px-4 py-3 text-gray-300">2 units</td>
                        <td class="px-4 py-3">
                            <span class="bg-orange-800 text-orange-100 px-3 py-1 rounded-full text-sm">High</span>
                        </td>
                        <td class="px-4 py-3">
                            <a href="donation_centers.php" class="bg-primary-600 hover:bg-primary-700 text-white py-1 px-4 rounded">Donate</a>
                        </td>
                    ...
                    <tr class="hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3 text-gray-300">Apollo Hospital</td>
                        <td class="px-4 py-3 text-gray-300">1 unit</td>
                        <td class="px-4 py-3">
                            <span class="bg-yellow-700 text-yellow-100 px-3 py-1 rounded-full text-sm">Medium</span>
                        </td>
                        <td class="px-4 py-3">
                            <a href="donation_centers.php" class="bg-primary-600 hover:bg-primary-700 text-white py-1 px-4 rounded">Donate</a>
                        </td>
        ...
        <div class="mt-6 text-center">
            <p class="text-gray-400 mb-4">If you're able to donate, please consider helping with these urgent needs.</p>
            <a href="request_blood.php" class="text-primary-400 hover:text-primary-300 inline-flex items-center">
...
<section class="py-16 bg-gradient-dark relative overflow-hidden">
    <div class="container mx-auto px-4">
        <div class="text-center mb-10">
            ...
            <p class="text-gray-400">Your donation makes a life-changing difference</p>
        </div>
        
        <!-- 2x2 Grid layout -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Card 1 -->
            <div class="modern-card p-6 flex flex-col justify-center">
                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center mx-auto mb-6 shadow-neon">
                    <i class="fas fa-user-friends text-2xl text-white"></i>
                </div>
                <h3 class="text-xl font-bold text-center text-white mb-4">Save Lives</h3>
                <p class="text-gray-300 text-center mb-6">Every few minutes, someone in India needs blood. A single donation can save up to 3 lives.</p>
                <div class="glassmorphism p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-white font-bold">12 Million</p>
                            <p class="text-gray-400 text-sm">Indians need blood annually</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Card 2 -->
            <div class="modern-card p-6 flex flex-col justify-center">
                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-secondary-500 to-accent-500 flex items-center justify-center mx-auto mb-6 shadow-neon-blue">
                    <i class="fas fa-hospital text-2xl text-white"></i>
                </div>
                <h3 class="text-xl font-bold text-center text-white mb-4">Emergency Response</h3>
                ...
                <div class="glassmorphism p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-white font-bold">30 Million</p>
                            <p class="text-gray-400 text-sm">Blood components needed yearly</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Card 3 -->
            <div class="modern-card p-6 flex flex-col justify-center">
                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-accent-500 to-primary-500 flex items-center justify-center mx-auto mb-6 shadow-neon-purple">
                    <i class="fas fa-child text-2xl text-white"></i>
                </div>
                <h3 class="text-xl font-bold text-center text-white mb-4">Support Children</h3>
                <p class="text-gray-300 text-center mb-6">Children with thalassemia, cancer, and other conditions need regular blood transfusions and rely on generous donors.</p>
                <div class="glassmorphism p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-white font-bold">150,000+</p>
                            <p class="text-gray-400 text-sm">Children with thalassemia in India</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Card 4 -->
            <div class="modern-card p-6 flex flex-col justify-center">
                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-green-500 to-blue-500 flex items-center justify-center mx-auto mb-6 shadow-neon-blue">
                    <i class="fas fa-notes-medical text-2xl text-white"></i>
                </div>
                <h3 class="text-xl font-bold text-center text-white mb-4">Health Benefits</h3>
                <p class="text-gray-300 text-center mb-6">Donating blood can help maintain iron levels, reduce the risk of heart disease, and balance your overall health.</p>
                <div class="glassmorphism p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-white font-bold">33% Reduced</p>
                            <p class="text-gray-400 text-sm">Risk of cardiac issues</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table class="w-full bg-gray-800 rounded-lg overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3 text-gray-300">~8%</td>
                    </tr>
                    <tr class="hover:bg-gray-700">
                        <td class="px-4 py-3 font-bold text-primary-500">AB-</td>
                    ...
                    <tr class="hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3 text-gray-300">~27%</td>
                    </tr>
                    <tr class="hover:bg-gray-700">
                        <td class="px-4 py-3 font-bold text-primary-500">O-</td>
                        <td class="px-4 py-3 text-gray-300">All Types</td>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-gray-900 p-6 rounded-lg">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <h3 class="text-white font-bold">Priya Sharma</h3>
                        <p class="text-gray-400 text-sm">Regular Donor</p>
                    </div>
                </div>
                <p class="text-gray-300">"I've been donating blood regularly for five years at the Red Cross center in Delhi. Knowing that my donation could help thalassemia patients gives me immense satisfaction. The process is quick and the staff is always friendly."</p>
            </div>
            ...
            <div class="bg-gray-900 p-6 rounded-lg">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-gray-700 rounded-full mr-4"></div>
                    <div>
                        <h3 class="text-white font-bold">Arjun Patel</h3>
                        <p class="text-gray-400 text-sm">First-time Donor</p>
                    </div>
                </div>
                <p class="text-gray-300">"I was nervous about donating blood for the first time at AIIMS, but the staff made me feel comfortable. The process was much easier than I expected, and now I plan to donate regularly to help my community."</p>
            </div>
            ...
            <div class="bg-gray-900 p-6 rounded-lg">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-gray-700 rounded-full mr-4"></div>
                    <div>
                        <h3 class="text-white font-bold">Meera Desai</h3>
                        <p class="text-gray-400 text-sm">Blood Recipient</p>
                    </div>
                </div>
                <p class="text-gray-300">"After a serious accident in Mumbai, I needed multiple blood transfusions. I'm alive today because of generous blood donors. Now I volunteer at blood drives across Maharashtra to give back to the community that saved me."</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-gray-900 rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                    <div class="text-gray-400 text-sm mb-2">June 14, 2025 | National Blood Donor Day</div>
            ...
            <div class="bg-gray-900 rounded-lg overflow-hidden">
                <div class="h-48 bg-gray-700"></div>
                <div class="p-6">
                    <div class="text-gray-400 text-sm mb-2">May 15, 2025 | NBTC Updates</div>
                    <h3 class="text-xl font-bold text-white mb-2">National Blood Transfusion Council Initiatives</h3>
                    <p class="text-gray-300 mb-4">Discover the latest advancements in blood storage technology that are extending shelf life and improving accessibility across India.</p>
                    <a href="#" class="text-primary-500 hover:text-primary-400 inline-flex items-center">
                        Read more
                        <i class="fas fa-arrow-right ml-2"></i>
                    </a>
