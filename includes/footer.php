            ...
            if (message !== '') {
                    ...
                    <div id="${typingIndicatorId}" class="flex mb-4">
                        ...
                        <div class="bg-gray-700/50 rounded-lg p-3 max-w-[80%]">
                            <div class="flex space-x-2">
                                <div class="bg-gray-500 w-2 h-2 rounded-full animate-bounce"></div>
                                <div class="bg-gray-500 w-2 h-2 rounded-full animate-bounce" style="animation-delay: 0.2s"></div>
                                <div class="bg-gray-500 w-2 h-2 rounded-full animate-bounce" style="animation-delay: 0.4s"></div>
                            </div>
                        </div>
                    </div>
                `;
                ...
                fetch('https://api.openai.com/v1/chat/completions', {
                    ...
                    headers: {
                        ...
                        'Authorization': 'Bearer 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'
                    },
                    body: JSON.stringify({
                        model: "gpt-3.5-turbo",
                        messages: [
                            {
                                role: "system",
                                content: "You are a helpful assistant for BloodLink, an Indian blood donation platform. Keep responses concise, friendly, and informative about blood donation in India. Provide information about blood types, donation process, eligibility criteria, and the importance of donation. If asked about specific hospitals or centers, refer to well-known ones in Delhi like AIIMS, Apollo, and Fortis. Never share personal medical advice or diagnose conditions."
                            },
                            {
                                role: "user",
                                content: message
                ...
                .catch(error => {
                    ...
                    chatbotMessages.innerHTML += `
                        <div class="flex mb-4">
                            ...
                            <div class="bg-gray-700/50 rounded-lg p-3 max-w-[80%]">
                                <p class="text-white text-sm">I'm currently having trouble connecting to my knowledge base. Please try again later or contact our support team for assistance.</p>
                            </div>
                        </div>
                    `;
